...
```
cd harvey-senior-homes
mkvirtualenv harvey-senior-homes
...
View the [sample copy spreadsheet](https://docs.google.com/spreadsheet/pub?key=1e-0bbDyiYVlERBzRQnp9-cQgv448vv5kWSu5DlsELxM#gid=0).
...
def read_my_google_doc():
    ...
    get_document('1e-0bbDyiYVlERBzRQnp9-cQgv448vv5kWSu5DlsELxM', file_path)
    data = Copy(file_path)
...
```
* * * * * ubuntu bash /home/ubuntu/apps/harvey_senior_homes/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|harvey-senior-homes|tweet|`location`||
|harvey-senior-homes|facebook|`location`||
|harvey-senior-homes|email|`location`||
|harvey-senior-homes|new-comment||
|harvey-senior-homes|open-share-discuss||
|harvey-senior-homes|close-share-discuss||
|harvey-senior-homes|summary-copied||
|harvey-senior-homes|featured-tweet-action|`action`|
|harvey-senior-homes|featured-facebook-action|`action`|
